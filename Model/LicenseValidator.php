...
/**
 * License validation for Etechflow_CanonicalHreflang.
 *
...
class LicenseValidator
{
    ...
    public const XML_PATH_LICENSE_KEY            = 'etechflow_canonical/license/license_key';
    public const XML_PATH_ISSUED_KEY             = 'etechflow_canonical/license/issued_key';
    public const XML_PATH_ISSUED_AT              = 'etechflow_canonical/license/issued_at';
    public const XML_PATH_IP_BLOCKED             = 'etechflow_canonical/license/ip_blocked';
    public const XML_PATH_PORTAL_URL             = 'etechflow_canonical/license/portal_url';
    public const XML_PATH_PRODUCTION_ENVIRONMENT = 'etechflow_canonical/license/production_environment';
    ...
    private const CACHE_TAG    = 'ETECHFLOW_CANONICAL';
    private const CACHE_PREFIX = 'etf_canonical_lic_';

    // ── HMAC — per-module (UNIQUE to canonical-hreflang; do not reuse elsewhere) ──
    private const MODULE_ID = 'canonical-hreflang';
    ...
    private function portalResult(string $host, string $key): array
    {
        ...
        try {
            ...
            $this->curl->addHeader('User-Agent', 'ETechFlow-CH/1.0');
            $this->curl->get($url);
