...
namespace Etechflow\CanonicalHreflang\Block\Adminhtml\System\Config;
...
/**
 * Status banner at the top of the Canonical & Hreflang admin config section.
 *
        ...
        if (!$licenceValid) {
            if (!$hasKey) {
                return $this->banner(
                    ...
                    . '<a href="' . $this->getUrl('canonicalhreflang/license/gate') . '" style="color:inherit;text-decoration:underline;">License &amp; Plans</a> '
                    . 'to purchase one.'
                );
            }
