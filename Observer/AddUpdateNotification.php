...
{
    private const PACKAGE     = 'etechflow/module-canonical-hreflang';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-canonical-hreflang.json';
    private const CACHE_KEY   = 'etechflow_rs_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_CanonicalHreflang';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow Canonical & Hreflang %1 is available', $latest['version']);
